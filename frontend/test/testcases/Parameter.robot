...
PL_01 Verify that navigate to the exact tab of "Linkedin"
  [Tags]                                                                                                MainPage                   Linkedin                 UI                     Smoketest
  Login to admin
  Click "Thiết lập" menu
  When Click "Tham số" sub menu to "/setting/parameter"
  When Click on "Linkedin" tab
...
PL_02 Verify the User Interface of "Linkedin" tab in "Danh sách tham số" page
  [Tags]                                                                                                MainPage                   Linkedin                 UI                     Smoketest
  Login to admin
  Click "Thiết lập" menu
  When Click "Tham số" sub menu to "/setting/parameter"
...
PL_03 Verify that navigate to the exact tab of "Facebook"
  [Tags]                                                                                                MainPage                   Facebook                 UI                     Smoketest
  Login to admin
  Click "Thiết lập" menu
  When Click "Tham số" sub menu to "/setting/parameter"
  When Click on "Facebook" tab
  Then Heading should contain "Danh sách tham số" inner text
  Then Confirm locating exactly in "Tham số" page of "Thiết lập" menu
  Then Heading of separated group should contain "Chỉnh sửa tham số facebook" inner text 

PL_04 Verify the User Interface of "Facebook" tab in "Danh sách tham số" page
  [Tags]                                                                                                MainPage                   Facebook                 UI                     Smoketest
  Login to admin
  Click "Thiết lập" menu
  When Click "Tham số" sub menu to "/setting/parameter"
...
PL_05 Verify that navigate to the exact tab of "Phone"
...
PL_06 Verify the User Interface of "Phone" tab in "Danh sách tham số" page
  [Tags]                                                                                                MainPage                   Phone                 UI                     Smoketest
  Login to admin
  Click "Thiết lập" menu
  When Click "Tham số" sub menu to "/setting/parameter"
...
PL_07 Verify that navigate to the exact tab of "Email"
...
PL_08 Verify the User Interface of "Email" tab in "Danh sách tham số" page
  [Tags]                                                                                                MainPage                   Email                 UI                     Smoketest
  Login to admin
  Click "Thiết lập" menu
  When Click "Tham số" sub menu to "/setting/parameter"
...
PL_09 Verify that navigate to the exact tab of "Address"
  [Tags]                                                                                                MainPage                   Address                 UI                     Smoketest
  Login to admin
  Click "Thiết lập" menu
  When Click "Tham số" sub menu to "/setting/parameter"
...
PL_10 Verify the User Interface of "Address" tab in "Danh sách tham số" page
  [Tags]                                                                                                MainPage                   Address                 UI                     Smoketest
  Login to admin
  Click "Thiết lập" menu
  When Click "Tham số" sub menu to "/setting/parameter"
...
PL_11 Verity that edit information in "Linkedin" tab by changing the data in "Tiếng Việt" input field with valid data
...
PL_12 Verity that edit information in "Linkedin" tab by changing the data in "Tiếng Anh" input field with valid data
  [Tags]                                                                                                EditInfo                   Linkedin
  Go to "Danh sách tham số" page with "Linkedin" list
...
# PL_13 Verity that CAN NOT edit information in "Linkedin" tab by leaving blank field in "Tiếng Việt" 
#   [Tags]                                                                                                EditInfo                   Linkedin
#   Go to "Danh sách tham số" page with "Linkedin" list
...
# PL_14 Verity that CAN NOT edit information in "Linkedin" tab by leaving blank field in "Tiếng Anh" 
#   [Tags]                                                                                                EditInfo                   Linkedin
#   Go to "Danh sách tham số" page with "Linkedin" list
...
PL_15 Verity that edit information in "Facebook" tab by changing the data in "Tiếng Việt" input field with valid data
...
PL_16 Verity that edit information in "Facebook" tab by changing the data in "Tiếng Anh" input field with valid data
  [Tags]                                                                                                EditInfo                   Facebook
  Go to "Danh sách tham số" page with "Facebook" list
  When Enter "text" in "Tiếng Anh" with "_RANDOM_"
  When Click "Lưu lại" button
...
# PL_17 Verity that CAN NOT edit information in "Facebook" tab by leaving blank field in "Tiếng Việt" 
#   [Tags]                                                                                                EditInfo                   Facebook
#   Go to "Danh sách tham số" page with "Facebook" list
#   When Enter "text" in "Tiếng Việt" with ""
#   When Click "Lưu lại" button
...
# PL_18 Verity that CAN NOT edit information in "Facebook" tab by leaving blank field in "Tiếng Anh" 
#   [Tags]                                                                                                EditInfo                   Facebook
#   Go to "Danh sách tham số" page with "Facebook" list
#   When Enter "text" in "Tiếng Anh" with ""
#   When Click "Lưu lại" button
...
PL_19 Verity that edit information in "Phone" tab by changing the data in "Tiếng Việt" input field with valid data
  [Tags]                                                                                                EditInfo                   Phone
...
PL_20 Verity that edit information in "Phone" tab by changing the data in "Tiếng Anh" input field with valid data
  [Tags]                                                                                                EditInfo                   Phone
  Go to "Danh sách tham số" page with "Phone" list
...
# PL_21 Verity that CAN NOT edit information in "Phone" tab by leaving blank field in "Tiếng Việt" 
#   [Tags]                                                                                                EditInfo                   Phone
#   Go to "Danh sách tham số" page with "Phone" list
...
# PL_22 Verity that CAN NOT edit information in "Phone" tab by leaving blank field in "Tiếng Anh" 
#   [Tags]                                                                                                EditInfo                   Phone
#   Go to "Danh sách tham số" page with "Phone" list
...
PL_23 Verity that edit information in "Email" tab by changing the data in "Tiếng Việt" input field with valid data
  [Tags]                                                                                                EditInfo                   Email
...
PL_24 Verity that edit information in "Email" tab by changing the data in "Tiếng Anh" input field with valid data
  [Tags]                                                                                                EditInfo                   Email
  Go to "Danh sách tham số" page with "Email" list
...
# PL_25 Verity that CAN NOT edit information in "Email" tab by leaving blank field in "Tiếng Việt" 
#   [Tags]                                                                                                EditInfo                   Email
#   Go to "Danh sách tham số" page with "Email" list
...
# PL_26 Verity that CAN NOT edit information in "Email" tab by leaving blank field in "Tiếng Anh" 
#   [Tags]                                                                                                EditInfo                   Email
#   Go to "Danh sách tham số" page with "Email" list
...
PL_27 Verity that edit information in "Address" tab by changing the data in "Tiếng Việt" input field with valid data
...
PL_28 Verity that edit information in "Address" tab by changing the data in "Tiếng Anh" input field with valid data
  [Tags]                                                                                                EditInfo                   Address
  Go to "Danh sách tham số" page with "Address" list
  When Enter "text" in "Tiếng Anh" with "_RANDOM_"
  When Click "Lưu lại" button
...
# PL_29 Verity that CAN NOT edit information in "Address" tab by leaving blank field in "Tiếng Việt" 
#   [Tags]                                                                                                EditInfo                   Address
#   Go to "Danh sách tham số" page with "Address" list
#   When Enter "text" in "Tiếng Việt" with ""
#   When Click "Lưu lại" button
...
# PL_30 Verity that CAN NOT edit information in "Address" tab by leaving blank field in "Tiếng Anh" 
#   [Tags]                                                                                                EditInfo                   Address
#   Go to "Danh sách tham số" page with "Address" list
#   When Enter "text" in "Tiếng Anh" with ""
#   When Click "Lưu lại" button
